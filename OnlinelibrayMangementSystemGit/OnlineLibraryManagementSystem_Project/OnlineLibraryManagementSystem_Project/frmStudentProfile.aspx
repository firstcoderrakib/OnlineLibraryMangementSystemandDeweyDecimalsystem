<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmStudentProfile.aspx.cs" Inherits="OnlineLibraryManagementSystem_Project.frmStudentProfile" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContNav" runat="server">
     <ul class="breadcrumb">
				...
				<li><a href="frmStudentProfile.aspx">Student Profile</a></li>
			</ul>
</asp:Content>
				...
				<div class="box span12">
					...
					<div class="box-content">
                        ...
                        <div style=" width:100%">
                          ...
                          <div style="width:48%; float:left">
                              <asp:Image ID="imgStudent" Width="100px" Height="100px" runat="server" /></div>
                       </div>
                     </div>
				</div>
