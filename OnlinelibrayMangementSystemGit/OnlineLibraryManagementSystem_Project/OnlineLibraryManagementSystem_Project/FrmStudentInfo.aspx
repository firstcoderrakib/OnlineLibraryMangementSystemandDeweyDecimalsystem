<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="FrmStudentInfo.aspx.cs" Inherits="OnlineLibraryManagementSystem_Project.FrmStudentInfo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContNav" runat="server">
     <ul class="breadcrumb">
				...
				<li><a href="FrmStudentInfo.aspx">Student Information Entry</a></li>
			</ul>
</asp:Content>
    ...
    <div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Student Information Entry</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                           <table>
                            <tr>
                                <td>
                                     <asp:Label ID="lblMess" runat="server" Text=""  ForeColor="#00cc99"></asp:Label>
                                 </td>
                            </tr>

                            <tr>
                                <td>
                                      <asp:Label ID="lblError" runat="server" Text="" ForeColor="#990000"></asp:Label>
                                 </td>
                              </tr>
                        </table>
                        ...
                        <table>
                             ...
                             <tr>
                               <td></td> <td></td>  <td></td> <td></td>  <td> <asp:Image ID="Image1"   ImageAlign="AbsMiddle" runat="server" Width="100px" Height="100px"/></td>
                               
                            </tr>
                       

                             <tr>
                                <td> <asp:Label ID="Label2" runat="server" Text="StudentName:" CssClass="control-label"></asp:Label></td>
                                <td> <asp:TextBox ID="txtStudentName"   CssClass="input-xlarge focused" runat="server"></asp:TextBox></td>
                            </tr>
                           
                           

                             <tr>
                                <td> <asp:Label ID="Label1" runat="server" Text="Student ID:" CssClass="control-label"></asp:Label></td>
                                <td> <asp:TextBox ID="txtStudentID"  CssClass="input-xlarge focused" runat="server"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                <td> <asp:Label ID="Label7" runat="server" Text="Father Name:" CssClass="control-label"></asp:Label></td>
                                <td> <asp:TextBox ID="txtFatherName"   CssClass="input-xlarge focused" runat="server"></asp:TextBox></td>
                            </tr>

                             <tr>
                                <td> <asp:Label ID="Label8" runat="server" Text="Mather Name:" CssClass="control-label"></asp:Label></td>
                          ...
                          <%--  <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td> <asp:Label ID="label7" runat="server" Text="StudentPic:" CssClass="control-label"></asp:Label></td>
